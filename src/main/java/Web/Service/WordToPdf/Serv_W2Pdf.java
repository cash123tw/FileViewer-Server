...
public class Serv_W2Pdf {
    ...
    @Autowired
    public Serv_W2Pdf(Controller_FileDetail controllerFileDetail, Serv_DataEditor fileDataService, Serv_Type_Impl fileTypeService, Serv_GetFile_FromDataBase fileService, FileDownloader fileDownloader, WordToPdf w2p) {
    ...
    public FilePath transfer2Pdf(Integer id) throws Exception {
        ...
        FilePath pdfFilePath = new FilePath(pdfFile.getName(), pdfFile.toPath(), fileType);
